package com.example.oop.methods.commons.util;
...
import com.example.oop.methods.lab1.LibraryService;
...
public class IOService {
    ...
    public static Library loadFromXml() {
        try {
            ...
            String filePath = "src/main/resources/lab1/input/input.xml";
            String schemaPath = "src/main/resources/lab1/input/input-schema.xsd";
    ...
    public static boolean writeToXml(Library library, String fileName) {
        try {
            ...
            for (Author author: authors) {
                ...
                xmlAuthor.setAttribute("date-of-birth", author.getBirthDay());
            ...
            String dstFilePath = String.format("src/main/resources/lab1/output/%s_%d.xml", fileName, System.currentTimeMillis());
    ...
    public static void writeToConsole(Library library) {
        List<Author> authors = library.getAuthors();
        ...
        for (Author author: authors) {
            ...
            for (Book book: ls.getBooksByAuthorId(author.getId())) {
